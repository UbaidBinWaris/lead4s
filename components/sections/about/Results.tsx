...
function StatItem({ value, suffix, label, sub, start }: Readonly<StatProps>) {
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-base leading-relaxed text-slate-400 italic">
            &ldquo;Lead4s transformed our acquisition model. Within 90 days, our cost
            per acquisition dropped 40% while contact rate jumped to 62%. We
            haven&apos;t looked at another vendor since.&rdquo;
          </p>
          <footer className="mt-5">
            <cite className="not-italic">
              <span className="text-sm font-semibold text-white">Marcus T.</span>
              <span className="mx-2 text-slate-600">·</span>
              <span className="text-xs text-slate-500">VP Sales, Regional Insurance Carrier</span>
            </cite>
          </footer>
        </motion.blockquote>
      </div>
