    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Lead4s is a performance-driven lead generation network connecting
            high-growth businesses with verified, purchase-ready consumers.
            We don&apos;t sell impressions — we deliver revenue.
          </motion.p>
          ...
          >
            {["TCPA Compliant", "TrustedForm Certified", "SOC 2 Ready", "50+ State Coverage"].map(
              (badge) => (
                <span
                  key={badge}
